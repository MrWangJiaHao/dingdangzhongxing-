...
//设备管理=>PDA管理=条件查询
export function queryPDAcon(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehousePda/findRecord",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>PDA管理=分页查询
export function queryPDApage(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehousePda/findRecordPage",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>PDA管理=删除PDA
export function delPDA(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehousePda/delRecord",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
export function savePDA(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehousePda/saveRecord",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>PDA管理=查看PDA详情
export function lookPDAdetail(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehousePda/findRecord",
            method: "post",
...
export function uploadImg(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehousePda/saveOrgImg",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>监控设备管理=新增/修改监控设备
export function saveMonitoringAids(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehouseMonitor/saveRecord",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>监控设备管理=分页查询
export function queryMonitoringAids(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehouseMonitor/findRecordPage",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>监控设备管理=条件查询
export function queryMonitoringAidsCon(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehouseMonitor/findRecord",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
...
//设备管理=>监控设备管理=删除监控设备
export function delMonitoringAids(data) {
    return new Promise((resolve, reject) => {
        service.request({
            url: "/wbs-warehouse-manage/v1/pWarehouseMonitor/delRecord",
            method: "post",
            data,
        }).then((ok) => {
            resolve(ok)
