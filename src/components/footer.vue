	...
	<div class="footer_box">
		<div class="dianJiTuiChu">
			<div class="displayalign">
				...
				<div class="wenZi" @mouseleave="_leaveOutLogin" @mouseout="_mouseOutLogin" @click="loginOutMeg">
					登录用户&nbsp;
					<span>:<span class="ml11"> {{ userName }}</span></span>
				</div>
			</div>
		</div>
		<transition enter-active-class="animate__animated animate__bounceInUp" leave-active-class="animate__animated animate__bounceOutDown">
			<div v-show="display" class="loginOut tc">
				<div @mouseleave="_leaveOutLogin" @mouseout="_mouseOutLogin"  @click="loginout" class="clickLoginOutCenter">退出登入</div>
			</div>
		</transition>
		<div class="dianJiXiaoXi">
			<div class="displayalign">
				...
				<div class="xiaoXiCenters ellipsis" @mouseout="xiaoxiout" @mouseleave="xiaoxiLeave" @click="xiaoxiClick">
					<div class="idBVox">
						{{ content }}
					</div>
				</div>
...
<style lang="scss" scoped>
	...
	.footer_box {
		...
		.loginOut {
			...
			bottom: 37px;
			left: 100px;
			box-shadow: 2px 7px 11px 1px #888888;
			background: #fff;
			border-radius: 8px;
