<template>
	<div class="setUserIngBox">
		<kuanjiaClick titles="打印出库单" min-height='500'  @closeBtn="closeBtn" :isLookerShow="false" print="打印" width="1080" @clickSubmit="printWarehouseReceipt">
			<template slot="centerKuanjia">
				<div class="mb16 displayCenter">
					<div id="printCenter" class="ptb3020">
                ...
                ">
                  ...
                  "
                    ...
                    ">
									...
									<div>
										<el-table style="width: 980px" :data="tableDatas" border highlight-current-row>
											<el-table-column type="index" label="序号" width="50">
											</el-table-column>
											<el-table-column property="prodCode" label="产品编码" style="text-align: center; width: 80px">
											</el-table-column>
											<el-table-column property="prodName" label="产品名称" width="120">
											</el-table-column>
											<el-table-column property="specName" label="产品规格">
											</el-table-column>
											<el-table-column property="prodNum" label="申请出库数量">
											</el-table-column>
											<el-table-column property="shijishulian" label="实际入库数量">
											</el-table-column>
                  ...
                  ">
									...
									<div v-if="tableDatas.length >= 5" style="
                    display: inline-block;
                    font-size: 14px;
                    color: #000000;
                    font-weight: normal;
...
<script>
	...
	export default {
		...
		methods: {
			...
			_changeTime() {
				this.Newtime = new Date().toLocaleString("chinese", {
					hour12: false
				});
			},
		},
