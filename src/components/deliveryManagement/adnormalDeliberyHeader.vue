<template>
	<headerKuanJia @clickQueryUser="clickQueryUser" left-width="95%" @clearInputAll="clearInputAll">
		<template>
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20">
						<el-select class="w160" v-model="paras.channelName" slot="prepend" placeholder="请选择渠道" @input="getchannelName"
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20">
						<el-select class="w160" v-model="paras.orderSourceName" slot="prepend" placeholder="请选择订单来源" @focus="getOrderSourceName"
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<inputHeader @changereplenishOrderNo="orderNoFn" :buhuodanhaoJson="orderNoJson">
					</inputHeader>
				</div>
			</div>
			<!-- 订单号 -->
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<inputHeader @changereplenishOrderNo="subOrderNoFn" :buhuodanhaoJson="subOrderNoJson" />
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<inputHeader @changereplenishOrderNo="addressFn" :buhuodanhaoJson="addressJson" />
				</div>
			</div>
			<!-- 产品名称 -->
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<inputHeader @changereplenishOrderNo="prodNameFn" :buhuodanhaoJson="prodNameJson" />
			...
			<div v-if="fastFahuo" class="displayalign mb16 zujianBox">
				...
				<div class="mr20">
					<el-select class="w120" v-model="paras.printExprStatus" slot="prepend" placeholder="请选择物物流打印状态" @input="changewiliudayarr">
...
<script>
	...
	export default {
		...
		methods: {
			...
			prodNameFn(e){
				this.paras.prodNameLike = e
			},
			//获取数组
			async _getMes() {
				let {
					result
				} = await pOrgFailSubOrderfindRecordPageGroupByProd(
					this.sendoutData
				);
			...
			clearInputAll() {
				...
				this.orderNoJson.input = ''
				this.addressJson.input = ''
				this.subOrderNoJson.input = ''
				this.prodNameJson.input = ''
