    ...
    <template>
      ...
      <div class="zujianBox mb16">
        <div class="displayalign zujianBox">
          ...
          <inputHeader
            @changereplenishOrderNo="orderNoFn"
            :buhuodanhaoJson="orderNoJson"
          >
          </inputHeader>
        </div>
      </div>
      ...
      <div class="zujianBox mb16">
        <div class="displayalign zujianBox">
          ...
          <inputHeader
            @changereplenishOrderNo="subOrderNoFn"
            :buhuodanhaoJson="subOrderNoJson"
          />
        </div>
      </div>
      <!-- 子单号 -->
      ...
      <div class="zujianBox mb16">
        <div class="displayalign zujianBox">
          ...
          <inputHeader
            @changereplenishOrderNo="addressFn"
            :buhuodanhaoJson="addressJson"
          />
        </div>
      </div>
      <!-- 产品名称 -->
      ...
      <div class="zujianBox mb16">
        <div class="displayalign zujianBox">
          ...
          <inputHeader
            @changereplenishOrderNo="prodNameFn"
            :buhuodanhaoJson="prodNameJson"
          />
        </div>
      </div>
      <!-- 产品名称 -->
