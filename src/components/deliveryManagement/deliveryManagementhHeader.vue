<template>
	<headerKuanJia @clickQueryUser="clickQueryUser" left-width="93%" @clearInputAll="clearInputAll">
		<template>
			<div class="displayalign mb16 zujianBox">
				<div class="noneIconTitle mr11">委托公司:</div>
				<div class="mr20">
					<el-select class="w320" v-model="paras.orgName" slot="prepend" :placeholder="EntrustedCompany.placeholder" @input="getOrdName"
					 @focus="getOrderArr">
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20">
						<el-select class="w120" v-model="paras.channelName" slot="prepend" placeholder="请选择渠道" @input="getchannelName"
						 @focus="changeChannelName">
							<el-option v-for="(item, idx) in channelNameJson.channelNameArr" :key="idx" :label="item.channelName" :value="idx"></el-option>
						</el-select>
					</div>
				</div>
			</div>
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20">
						<el-select v-model="paras.orderSourceName" class="w160" slot="prepend" placeholder="请选择订单来源" @focus="getOrderSourceName"
						 @input="changeOrderSourceName">
							<el-option v-for="(item, idx) in orderSourceNameJson.orderSourceName" :key="idx" :label="item.orderSourceName"
							 :value="idx"></el-option>
						</el-select>
					</div>
				</div>
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20">
						<inputHeader @changereplenishOrderNo="dindanhaoFn" :buhuodanhaoJson="dindanhaoJson"></inputHeader>
					</div>
				</div>
			</div>
			<!-- 订单号 -->
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div>
						<inputHeader @changereplenishOrderNo="subOrderNoArrFn" :buhuodanhaoJson="subOrderNoArr"></inputHeader>
					</div>
				</div>
			</div>
			<!-- 子单号 -->
			...
			<div class="displayalign mb16 zujianBox">
				...
				<div class="mr20">
					<el-select class="w150" v-model="paras.exprName" slot="prepend" placeholder="请选择物流公司" @input="changeExprName"
					 @focus="getexprName">
						<el-option v-for="(item, idx) in exprNameJson.exprNameArr" :key="idx" :label="item.exprName" :value="idx"></el-option>
					</el-select>
				</div>
			</div>
			<!-- 物流公司 -->
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div>
						<inputHeader @changereplenishOrderNo="orderContactFn" :buhuodanhaoJson="orderContactJson"></inputHeader>
					</div>
				</div>
			</div>
			<!-- 收货人 -->
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20">
						<inputHeader @changereplenishOrderNo="orderContactPhoneFn" :buhuodanhaoJson="orderContactPhoneJson"></inputHeader>
					</div>
				</div>
			</div>
			<!-- 联系电话 -->
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20 displayalign">
						<inputHeader className="w120" @changereplenishOrderNo="orderAddrFn" :buhuodanhaoJson="orderAddrJson"></inputHeader>

						<el-select class="w150" v-model="paras.orderAddr" slot="prepend" placeholder="请选择收货地址" @input="changeorderAddr">
							<el-option v-for="(item, idx) in addressJson.orderAddrArr" :key="idx" :label="item.orderAddr" :value="idx"></el-option>
						</el-select>
						<!--address 收货地址  -->
					</div>
				</div>
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20 displayalign">
						<inputHeader @changereplenishOrderNo="systemProdNameFn" :buhuodanhaoJson="systemProdNameJson"></inputHeader>

						<el-select class="w150" v-model="paras.systemProdName" slot="prepend" placeholder="请选择产品名称" @input="changeaddress"
						 @focus="getaddress">
							<el-option v-for="(item, idx) in systemProdName.systemProdNameArr" :key="idx" :label="item.systemProdName"
							 :value="idx"></el-option>
						</el-select>
						<!--address 产品名称  -->
					</div>
			...
			<div v-if="fastFahuo" class="displayalign mb16 zujianBox">
				...
				<div class="mr20">
					<el-select class="w190" v-model="paras.printExprStatus" slot="prepend" placeholder="请选择物物流打印状态" @input="changewiliudayarr">
						<el-option v-for="(item, idx) in wiliudayarr" :key="idx" :label="item.title" :value="item.id"></el-option>
					</el-select>
				</div>
			</div>
			<!-- 物流公司 -->
				...
				<div class="displayalign zujianBox">
					...
					<div class="mr20 displayalign">
						<div style="margin-right: 10px">
							<dateTime :dateTimeData="PayStartTime" @getDateTime="getPayStartTime" ref="expectedStart" />
						</div>
						<!-- 开始时间 -->
						<div class="line"></div>
						<div>
							<dateTime :dateTimeData="payEndTime" @getDateTime="getpayEndTime" ref="expectedEnd" />
						</div>
						<!-- 结束时间 -->
					</div>
				</div>
			...
			<div class="zujianBox mb16">
				<div class="displayalign zujianBox">
					...
					<div class="mr20 displayalign">
						<div style="margin-right: 10px">
							<dateTime :dateTimeData="pushStartTime" @getDateTime="getpushStartTime" ref="putStart" />
						</div>
						<!-- 开始时间 -->
						<div class="line"></div>
						<div>
							<dateTime :dateTimeData="pushEndTime" @getDateTime="getpushEndTime" ref="putEnd" />
						</div>
						<!-- 结束时间 -->
					</div>
				</div>
	...
	export default {
		...
		data() {
			return {
				...
				payEndTime: {
					placeholder: "请输入支付结束时间"
				},
				pushStartTime: {
					placeholder: "请选择下发开始时间"
				},
				pushEndTime: {
					placeholder: "请选择下发结束时间"
				},
				dindanhaoJson: {
					placeholder: "请输入订单号",
					input: "",
