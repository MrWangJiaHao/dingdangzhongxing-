<template>
	<div id="fahuoguanli">
		<div class="manualBox">
			<manualHeader @getParasJson="getParasJson" :fastFahuo="true" :tableData="tableData" />
			<div class="btnArr">
				<div class="backFF">
					<div style="display: flex; align-item: center">
						<div class="mr20 meiyiyetitle">快速发货</div>
						<div>
							<span class="disinb mr20 setUser nowrap" :class="!ischanpingOrOne?'ischanpingOrOneTrue':'ischanpingOrOneFalse'"
							 @click="isChangeTeShuChanPin(false)">特殊产品
							</span>
							<span class="disinb zhengcxhang nowrap" :class="ischanpingOrOne?'ischanpingOrOneTrue':'ischanpingOrOneFalse'"
							 @click=" isChangeTeShuChanPin(true)">只含一种产品
							</span>
						</div>
					</div>
					<div class="btnClick">
					...
					<div class="center">
						<el-table ref="multipleTable" :data="tableData" :stripe="true" :border="true" tooltip-effect="dark" style="width: 100%"
						 @selection-change="handleSelectionChange">
							...
							<el-table-column label="委托公司" width="119" prop="orgName" show-overflow-tooltip />
							<el-table-column width="119" label="渠道" prop="channelName" show-overflow-tooltip></el-table-column>
							<el-table-column width="250" label="订单来源" prop="orderSourceName" show-overflow-tooltip></el-table-column>
							<el-table-column width="250" label="产品名称" prop="orderSourceName" show-overflow-tooltip></el-table-column>
							<el-table-column width="250" label="产品编码" prop="orderSourceName" show-overflow-tooltip></el-table-column>
							<el-table-column width="250" label="产品规格" prop="orderSourceName" show-overflow-tooltip></el-table-column>
							<el-table-column width="250" label="产品数量" prop="orderSourceName" show-overflow-tooltip></el-table-column>
							<el-table-column label="订单号" width="250" prop="channelOrderNo" show-overflow-tooltip>
								<span slot-scope="scoped">
									<div @click="goToDetailOut(scoped.row)" class="lookDeatil">
										{{ scoped.row.channelOrderNo }}
									</div>
								</span></el-table-column>
							<el-table-column label="子单号" prop="subOrderNo" width="250" show-overflow-tooltip>
								<span slot-scope="scoped">
									<div @click="goToSubOrderNo(scoped.row)" class="lookDeatil">
										{{ scoped.row.subOrderNo }}
									</div>
								</span></el-table-column>
							<el-table-column width="250" label="物流公司" prop="exprName" show-overflow-tooltip></el-table-column>
							<el-table-column label="物流单号" width="250" prop="exprNo"></el-table-column>
							<el-table-column label="物流单打印状态" width="160" prop="commendBox"></el-table-column>
							<el-table-column label="收货人" width="160" prop="orderContact"></el-table-column>
							<el-table-column label="联系电话" width="250" prop="orderContactPhone" show-overflow-tooltip></el-table-column>
							<el-table-column label="收货地址" width="250" prop="pushStartTime" show-overflow-tooltip></el-table-column>
							<el-table-column label="支付时间" prop="payTime" width="250" show-overflow-tooltip></el-table-column>
							<el-table-column label="下发时间" prop="payTime" width="250" show-overflow-tooltip></el-table-column>
						</el-table>
					</div>
					<!-- 表格主体 -->
		...
		<div v-show="isJianHuoDanShow" class="bjBox">
			<transition enter-active-class="animate__animated animate__zoomIn" leave-active-class="animate__animated animate__zoomOut">
				<div v-if="isJianHuoDanShow">
					<div>
						<pickingList :dataBack="detailsJianHuoDan" :OneOrAddMes="true" @getiscaigoudanDetail="getiscaigoudanDetail" />
					</div>
				</div>
			</transition>
		</div>
		...
		<div v-show="iswuliudanOne" class="bjBox">
			<transition enter-active-class="animate__animated animate__zoomIn" leave-active-class="animate__animated animate__zoomOut">
				<div v-if="iswuliudanOne">
					<div>
						<logisticsList @getiswuliudanOne="getiswuliudanOne" :logisticsListJson="logisticsListJson" />
					</div>
				</div>
			</transition>
		</div>
...
<script>
	...
	export default {
		...
		methods: {
			isChangeTeShuChanPin(e) {
				this.ischanpingOrOne = e
			},
			getiswuliudanOne(e) {
