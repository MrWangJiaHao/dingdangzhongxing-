<template>
	<kuanjiaClick :titles="title" width="1200" @closeBtn="closeBtn" @clickSubmit="clickSubmit">
		<template>
			<div class="w1300">
				<dindanxiangq :title="titles" :detailsArr="isJiaGonOffice?caijieDetailArrs:addDetatilArrs"></dindanxiangq>
				<!--排期-->

				<chanpinmingxi :chanpinminxiJson="zhuheChangeArrJson" @tableSelectArrs="zhuhechanpinmingxitableSelectArrs"></chanpinmingxi>
				<!--组合产品明细-->
				asdsa
<tableCommin :tableDataJson='chukuchangpinminxiJson.tableDataJsonAndArr'></tableCommin>
asd
				<chanpinmingxi :chanpinminxiJson="zuhechanpinminxiJson" @tableSelectArrs="zuhechanpinminxiJsontableSelectArrs">
					<template>
				...
				<div class="mb20 chukuchanpingminxi ">
					<chanpinmingxi :chanpinminxi-json="chukuchangpinminxiJson" @tableSelectArrs="chukuchangpinminxiJsontableSelectArrs"></chanpinmingxi>
				</div>
			</div>
		</template>
	</kuanjiaClick>
